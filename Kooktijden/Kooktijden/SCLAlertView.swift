...
enum SCLAlertViewStyle {
    case Success, Error, Notice, Warning, Info, Edit, Kooktijden
}
...
class SCLAlertView: UIViewController {
    ...
    // Font
    let kDefaultFont = "Roboto-Light"
	let kButtonFont = "Roboto-Medium"
    ...
    func showKooktijden(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Kooktijden)
    }
    ...
    func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: SCLAlertViewStyle) -> SCLAlertViewResponder {
        ...
        switch style {
            ...
            case .Kooktijden:
                viewColor = UIColor.kooktijdenGreenColor()
                iconImage = UIImage(named: "kooktijden_chef_hat")!
        }
